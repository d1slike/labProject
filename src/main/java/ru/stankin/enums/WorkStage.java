...
public enum WorkStage {
    ...
    private static final class AllowedItemsSpace {
        ...
        private static final String[] STAGE_6_ALLOWED_UI_ITEMS = {ElementNames.TABLE_RESULTS, ElementNames.BUTTON_SHOW_CHART, ElementNames.BUTTON_CANCEL, ElementNames.BUTTON_EXIT};
